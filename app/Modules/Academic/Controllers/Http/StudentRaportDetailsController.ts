          ...
          data: [
            {
              ...
              mapel: data
                ...
                .map((res) => ({
                  ...
                  predikat_pengetahuan: predikat.find(item => res.nilaiPengetahuan >= item.scoreMinimum  && res.nilaiPengetahuan <= item.scoreMaximum && item.type == 'PREDIKAT')?.description || res.nilaiPengetahuan ,
                  predikat_keterampilan: predikat.find(item => res.nilaiKeterampilan >= item.scoreMinimum  && res.nilaiKeterampilan <= item.scoreMaximum && item.type == 'PREDIKAT')?.description || res.nilaiKeterampilan,
