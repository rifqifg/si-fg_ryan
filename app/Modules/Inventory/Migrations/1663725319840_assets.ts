  ...
  public async up() {
    this.schema
      ...
      .createTable(this.tableName, (table) => {
        ...
        table.uuid('asset_supplier_id').references('id').inTable('inventory.suppliers').onDelete('set null').onUpdate('cascade')
        table.integer('asset_status_id').unsigned().references('id').inTable('inventory.asset_statuses').onDelete('set null').onUpdate('cascade')
